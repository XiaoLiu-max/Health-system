...
//
//    @Override
//    public HealthData getDataByDate(Long userId, LocalDate date) {
//        HealthData data = healthDataMapper.selectByUserIdAndDate(userId, date);
//        return data == null ? new HealthData() : data;
//    }
//
//    // ========== 3. 查询用户全部历史数据 ==========
...
public class HealthDataServiceImpl extends ServiceImpl<HealthDataMapper, HealthData>
    ...
    public void saveDayData(HealthData data, Long userId, LocalDate recordDate) {
        ...
        if (!abnormalMsg.isEmpty()) {
            ...
            // 🔥 2. 【关键修复】自动发给所有好友！！！
            messageServices.pushAbnormalToAllFriends(userId, abnormalMsg);
        }
